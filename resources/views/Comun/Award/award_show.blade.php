            ...
            <div class="row content">
                @forelse($award as $aw)
                    ...
                    <div class="col s12 m4 l4 offset-m2 offset-l2">
                        <a href="{{URL::to('Trabajos/Comun/'.$aw->id_proyecto)}}" class="waves-effect waves-light btn left center">Ir al proyecto</a>
                    </div>

                    <div class="col s12 m4 l4 offset-m2 offset-l2">
                        <a href="{{URL::to('Premios/Comun')}}" class="waves-effect waves-light btn left center">Premios</a>
                    </div>
